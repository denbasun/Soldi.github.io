const reviewsData = [
    ...
    {img: 'user4.png', name: 'Margot Robbie', text: 'reviewsCard.reviewText4', mark: 4, PaymentMethod: "Visa", data: 'reviewsCard.footerData4'},
    {img: 'user5.png', name: 'Robert Black', text: 'reviewsCard.reviewText5', mark: 5, PaymentMethod: "PayPal", data: 'reviewsCard.footerData5'},
    {img: 'user6.png', name: 'Emily Stone', text: 'reviewsCard.reviewText6', mark: 4, PaymentMethod: "MasterCard", data: 'reviewsCard.footerData6'},
